			...
			<div className="relative z-10 w-full flex flex-col items-center text-white px-4 py-20">
				...
				<div className="flex flex-col sm:flex-row gap-10 justify-center items-stretch flex-wrap w-full">
					...
					<div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-10 w-full sm:w-[420px] flex flex-col items-center border border-white/20">
						<p className="text-2xl font-semibold mb-6 text-yellow-300">Quico</p>
					...
					<div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-10 w-full sm:w-[420px] flex flex-col items-center border border-white/20">
						...
						<div className="w-full flex flex-col gap-4">
							...
							<a
								href="https://calmasses.com"
								className="relative inline-flex items-center justify-center w-full rounded-full overflow-hidden py-3 px-6 font-semibold text-white shadow-lg shadow-black/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-black/50"
							>
								{/* Imatge de fons que cobreix TOT el botó */}
								<div
