...
export default function Contacte() {
  ...
  <div className="flex flex-col sm:flex-row gap-10 justify-center items-center flex-wrap w-full">
          {/* ---- Tarjeta Quico & Enric ---- */}
          <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-10 w-[90%] sm:w-[420px] flex flex-col items-center border border-white/20 mx-auto">
